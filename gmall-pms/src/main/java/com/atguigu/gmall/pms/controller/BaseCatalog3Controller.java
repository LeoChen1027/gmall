...
public class BaseCatalog3Controller {
    ...
    public Resp<BaseCatalog3Entity> info(@PathVariable("id") Long id){
    ...
    public Resp<Object> save(@RequestBody BaseCatalog3Entity baseCatalog3){
    ...
    public Resp<Object> update(@RequestBody BaseCatalog3Entity baseCatalog3){
