...
public class CategoryController {
    ...
    @GetMapping
    public Resp<List<CategoryEntity>> kindCategory(@RequestParam(value = "level",defaultValue = "0")int level,
        ...
        List<CategoryEntity> entityList = categoryService.list(queryWrapper);
