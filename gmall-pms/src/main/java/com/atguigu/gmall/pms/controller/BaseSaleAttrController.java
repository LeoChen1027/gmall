...
public class BaseSaleAttrController {
    ...
    public Resp<BaseSaleAttrEntity> info(@PathVariable("id") Long id){
    ...
    public Resp<Object> save(@RequestBody BaseSaleAttrEntity baseSaleAttr){
    ...
    public Resp<Object> update(@RequestBody BaseSaleAttrEntity baseSaleAttr){
