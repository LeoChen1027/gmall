...
public class BaseCatalog1Controller {
    ...
    public Resp<BaseCatalog1Entity> info(@PathVariable("id") Integer id){
    ...
    public Resp<Object> save(@RequestBody BaseCatalog1Entity baseCatalog1){
    ...
    public Resp<Object> update(@RequestBody BaseCatalog1Entity baseCatalog1){
