...
public class FlashPromotionController {
    ...
    public Resp<FlashPromotionEntity> info(@PathVariable("id") Long id){
    ...
    public Resp<Object> save(@RequestBody FlashPromotionEntity flashPromotion){
    ...
    public Resp<Object> update(@RequestBody FlashPromotionEntity flashPromotion){
